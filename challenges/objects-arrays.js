...
console.log(tyrann.period);

// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.

tyrann.roar = function(){return 'RAWERSRARARWERSARARARRRR';};

console.log(tyrann.roar());
...
graduates.sort(function(a,b){
    const aa = a.university;
    const bb = b.university;
...
let contactInfo = graduates.map(function(object){
    return `${object.first_name} ${object.email}`;
  });
...
let lowCaseAnimalNames = zooAnimals.map(function(object){
...
let lowPopulationAnimals = zooAnimals.filter(popCheck);
